...
?>
<?php //pr($user_data);die(); ?>
<?php //echo "logout-link"; ?>
                                        ...
                                        <form class="form-info-basic" id="account_form">
                                            ...
                                            <div class="form-group">
                                            	<div class="form-group-control">
                                                    ...
                                                    <input type="test" class="form-control" id="city" name="city" value="<?php echo $user_data->city ?>" placeholder="<?php _e('Enter City', ET_DOMAIN) ?>">
                                                </div>
                                            ...
                                            <div class="form-group">
                                            	<div class="form-group-control">
                                                    ...
                                                    <input type="test" class="form-control" id="state" name="state" value="<?php echo $user_data->state ?>" placeholder="<?php _e('Enter State', ET_DOMAIN) ?>">
                                                </div>
                                            ...
                                            <div class="form-group">
                                            	<div class="form-group-control">
                                                    ...
                                                    <input type="test" class="form-control" id="country" name="country" value="<?php echo $user_data->country ?>" placeholder="<?php _e('Enter Country', ET_DOMAIN) ?>">
                                                </div>
                                            ...
                                            <div class="form-group">
                                            	<div class="form-group-control">
                                                    <label><?php _e('Contact Number', ET_DOMAIN) ?></label>
                                                    <input type="test" class="form-control" id="phone" name="phone" value="<?php echo $user_data->phone ?>" placeholder="<?php _e('Enter Contact', ET_DOMAIN) ?>">
                                                </div>
											   ...
											   <div class="form-group">
                                            	<div class="form-group-control">
                                                    <label><?php _e('Graduation info', ET_DOMAIN) ?></label>
                                                    <input type="test" class="form-control" id="graduation" name="graduation" value="<?php echo $user_data->graduation ?>" placeholder="<?php _e('Enter Graduation info', ET_DOMAIN) ?>">
                                                </div>
                                               
                                            </div>
											      <div class="form-group">
                                            	<div class="form-group-control">
                                                    <label><?php _e('Post Graduation info', ET_DOMAIN) ?></label>
                                                    <input type="test" class="form-control" id="post_graduation" name="post_graduation" value="<?php echo $user_data->post_graduation ?>" placeholder="<?php _e('Enter Post Graduation info', ET_DOMAIN) ?>">
                                                </div>
                                            	...
                                            	<div class="form-group-control">
                                                    ...
                                                    <input type="test" class="form-control" id="experience" name="experience" value="<?php echo $user_data->experience ?>" placeholder="<?php _e('11 Monts/1 Year', ET_DOMAIN) ?>">
                                                </div>
											 </div>
											 <div class="form-group">
                                            	<div class="form-group-control">
                                                    <label><?php _e('experience', ET_DOMAIN) ?></label>
                                                  <input type="file" name="upload_document0" id="upload_document"/>
												 <!-- <input type="file" class="form-control" name="upload_document0" id="upload_document0" value="<?php //echo $user_data->fileToUpload ?>" > -->
                                            ...
                                            <div class="clearfix"></div>
											<div class="form-group-control">
                                                    <label><?php _e('Switch user', ET_DOMAIN) ?></label>
                                                    <input type="checkbox" class="" id="employer" name="employer" value="employer" placeholder="<?php _e('employer', ET_DOMAIN) ?>">
                                                </div>
