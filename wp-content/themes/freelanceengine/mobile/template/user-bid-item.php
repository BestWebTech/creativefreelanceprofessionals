    ...
    <div class="info-single-project-wrapper">
        <div class="container">
            ...
            <div class="info-bottom">
                ...
                <span class="price-project"><?php echo $bid->bid_budget_text ?></span>
            </div>
        </div>
    </div>
        ...
        <ul class="bid-top">
            ...
            <li class="stt-bid">
                ...
                <p class="btn-warpper-bid">
                    ...
                    <?php }elseif($project->post_status == "complete" && $bid->ID == $bid->project_accepted){ ?>
                        <a href="<?php echo $project->review_link ?>" class="btn-sumary btn-bid">
                            <?php _e("Review job", ET_DOMAIN) ?>
                        </a>
                    <?php }elseif($project->post_status == "close" && $bid->ID == $bid->project_accepted){ ?>
