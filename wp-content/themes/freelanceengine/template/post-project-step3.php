    ...
    <div class="step-content-wrapper content" style="<?php if($step != 1) echo "display:none;" ?>" >
    	<form class="post" role="form" class="validateNumVal">
            ...
            <div class="form-group">
            	<div class="row">
                	<div class="col-md-4">
                    	<label for="project_category" class="control-label title-plan"><?php _e("Groups", ET_DOMAIN); ?><br/><span><?php _e(" Select the most appropriate one(s)", ET_DOMAIN); ?></span></label>
                    </div>

                    <div class="col-md-8 col-sm-12">
                       <?php ae_tax_dropdown( 'project_category' ,
							  array(  'attr' => 'data-chosen-width="100%" data-chosen-disable-search="" multiple data-placeholder="'.__("Choose groups", ET_DOMAIN).'"',
