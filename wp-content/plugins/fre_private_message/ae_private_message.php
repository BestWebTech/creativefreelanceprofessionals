...
function ae_plugin_enqueue_scripts(){
    ...
    wp_localize_script('ae_plugin_js', 'ae_plugin_globals', array(
        'no_message' => __('<span class="no-message"><i class="fa fa-exclamation"></i>You have not created any converstation yet. <br/>
Please come back to your biders list in Project detail for starting a conversation with biders.</span>', ET_DOMAIN),
        'no_reply' => __('<span class="no-message"><i class="fa fa-exclamation"></i>You have not created any converstation yet. <br/>
Please come back to your biders list in Project detail for starting a conversation with biders.</span>', ET_DOMAIN),
        'user_ID' => $user_ID,
