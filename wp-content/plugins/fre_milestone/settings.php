...
// Define resolve mail tempate
$resolve_mail_template = '<p>Hello [employer],</p>'.
                         '<p>[freelancer] has resolved milestone "[milestone_name]" on project [project].</p>'.
                         '<p>Sincerely,<br />[blogname]';
define( 'RESOLVE_MAIL', $resolve_mail_template );

// Define reopen mail tempate
$reopen_mail_template = '<p>Hello [freelancer],</p>'.
                        '<p>[employer] has re-opened milestone "[milestone_name]" on project [project].</p>'.
                        '<p>Sincerely,<br />[blogname]</p>';
define( 'REOPEN_MAIL', $reopen_mail_template );

// Define close mail tempate
$close_mail_template =  '<p>Hello [freelancer],</p>'.
                        '<p>[employer] has closed milestone "[milestone_name]" on project [project].</p>'.
                        '<p>Sincerely,<br />[blogname]</p>';
    ...
    function ae_milestone_admin_settings( $pages ) {
            ...
            'groups' => array(
                array(
                    'args' => array(
                        ...
                        'id' => 'max_milestone',
                        'class' => '',
                        'desc' => __("Set up how many milestones per project", ET_DOMAIN)
                    ) ,
        ...
        $sections[] = array(
            ...
            'groups' => array(
                array(
                    ...
                    'fields' => array(
                        array(
                            ...
                            'text' => __("Email templates for update, resolve, reopen and close actions", ET_DOMAIN) . '<a class="icon btn-template-help payment" data-icon="?" href="#" title="View more details"></a>' . '<div class="cont-template-help payment-setting">
                ...
                // array(
                //     'args' => array(
                //         'title' => __("Create Milestone Template", ET_DOMAIN) ,
                //         'id' => 'ae-create-milestone-mail',
                //         'class' => 'payment-gateway',
                //         'name' => '',
                //         'desc' => __("Send email to all bidders when employer create a new milestone.", ET_DOMAIN),
                //         'toggle' => true
                //     ) ,
                //     'fields' => array(
                //         array(
                //             'id' => 'ae_create_milestone_mail_template',
                //             'type' => 'editor',
                //             'title' => __("Create Milestone Template", ET_DOMAIN) ,
                //             'name' => 'ae_create_milestone_mail_template',
                //             'class' => '',
                //             'reset' => 1
                //         )
                //     )
                ...
                // array(
                //     'args' => array(
                //         'title' => __("Remove Milestone Template", ET_DOMAIN) ,
                //         'id' => 'ae-remove-milestone-mail',
                //         'class' => 'payment-gateway',
                //         'name' => '',
                //         'desc' => __("Send email to freelancer when employer remove a milestone.", ET_DOMAIN),
                //         'toggle' => true
                //     ) ,
                //     'fields' => array(
                //         array(
                //             'id' => 'ae_remove_milestone_mail_template',
                //             'type' => 'editor',
                //             'title' => __("Remove Milestone Template", ET_DOMAIN) ,
                //             'name' => 'ae_remove_milestone_mail_template',
                //             'class' => '',
                //             'reset' => 1
                //         )
                //     )
                ...
                array(
                    'args' => array(
                        ...
                        'class' => 'payment-gateway',
                        'name' => '',
                        'desc' => __("Send email to all bidders when employer update milestone when edit project", ET_DOMAIN),
                        'toggle' => true
                    ) ,
                    'fields' => array(
                        array(
                ...
                array(
                    'args' => array(
                        ...
                        'class' => 'payment-gateway',
                        'name' => '',
                        'desc' => __("Send email to employer when freelancer resolve a milestone.", ET_DOMAIN),
                        'toggle' => true
                    ) ,
                    'fields' => array(
                        array(
                ...
                array(
                    'args' => array(
                        ...
                        'class' => 'payment-gateway',
                        'name' => '',
                        'desc' => __("Send email to freelancer when employer reopen a milestone.", ET_DOMAIN),
                        'toggle' => true
                    ) ,
                    'fields' => array(
                        array(
                ...
                array(
                    'args' => array(
                        ...
                        'class' => 'payment-gateway',
                        'name' => '',
                        'desc' => __("Send email to freelancer when employer mark done a milestone.", ET_DOMAIN),
                        'toggle' => true
                    ) ,
                    'fields' => array(
                        array(
        ...
        $pages[] = array(
            'args' => array(
                ...
                'page_title' => __('AE Milestone', ET_DOMAIN) ,
                'menu_title' => __('MILESTONE', ET_DOMAIN) ,
                'cap' => 'administrator',
                'slug' => 'ae-milestone',
                'icon' => 'M',
                'icon_class' => 'fa fa-check',
                'desc' => __("All setings for milestone plugin", ET_DOMAIN)
            ),
            'container' => $container
        );
