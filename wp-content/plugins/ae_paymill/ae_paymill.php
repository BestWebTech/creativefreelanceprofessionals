...
function ae_paymill_require_plugin_file(){
    require_once dirname(__FILE__) . '/update.php';
}
add_action('after_setup_theme', 'ae_paymill_require_plugin_file');
...
add_action('ae_payment_script', 'ae_paymill_add_script');
function ae_paymill_add_script() {
    global $user_ID, $ae_post_factory;
    $ae_pack = $ae_post_factory->get('pack');
    $packs = $ae_pack->fetch();
